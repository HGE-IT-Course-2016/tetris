...
public class T extends Stein
{
    ...
    protected boolean checkRot(int r) {
        ...
        r = checkRotation(r);
        if(rot == 0) {
            if ( checkPos(x-1,y) == true && checkPos(x+1,y) == true && checkPos(x,y) == true && checkPos(x,y+1) == true )
            {
                return true;
            }
            else
            ...
            if ( checkPos(x,y-1) == true && checkPos(x,y) == true && checkPos(x,y+1) == true && checkPos(x-1,y) == true )
            {
                return true;
            }
            else
            ...
            if ( checkPos(x+1,y) == true && checkPos(x,y) == true && checkPos(x-1,y) == true && checkPos(x,y-1) == true )
            {
                return true;
            }
            else
